...
const TaskManagementForm = () => {
    ...
    const difficulties = [
        { value: "easy", label: "Easy", color: "bg-green-500", icon: "⭐" },
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-purple-100">
                                    Design engaging tasks for your users with rewards and requirements
                                </p>
                            </div>
                        </div>
                        <div
                    ...
                    <div className="lg:col-span-2 space-y-6">
                            ...
                            {formData.type === "article" && (
                                <div>
                                    ...
                                    <p className="text-xs text-gray-500 mt-2">
                                        💡 Users will need to read this content to complete the task
                                    </p>
                                </div>
                            )}
                            ...
                            {formData.type === "checkin" && (
                                <div className="text-center py-12">
                                    ...
                                    <p className="text-gray-600">
                                        No additional requirements needed. Users just need to check in daily!
                                    </p>
                                </div>
                            )}
                        </div>
                        ...
                        <div className="bg-white rounded-2xl shadow-xl p-8">
                            <div className="flex items-center gap-3 mb-6">
                                ...
                                <h2 className="text-2xl font-bold text-gray-800">Rewards & Limits</h2>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input
                                        ...
                                        onChange={(e) =>
                                            handleRewardChange("points", parseInt(e.target.value) || 0)
                                        }
                                ...
                                <label className="flex items-center justify-between cursor-pointer group">
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500">
                                            {formData.isActive ? "Task is active" : "Task is inactive"}
                                        </p>
                                    </div>
                                    <div
                                ...
                                <div className="space-y-3">
                                    ...
                                    <div className="flex items-center justify-between">
                                        ...
                                        <div className="flex items-center gap-2">
                                            <div
                                                className={`w-3 h-3 rounded-full ${selectedDifficulty?.color}`}
                                            />
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-purple-700">
                                        {formData.type === "article" &&
                                            "Make sure the article is engaging and provides value to readers."}
                                        {formData.type === "survey" &&
                                            "Keep questions clear and provide meaningful options."}
                                        {formData.type === "checkin" &&
                                            "Daily check-ins help build user engagement and habits."}
                                    </p>
                                </div>
                            </div>
                        </div>
